...
if(!empty($_POST["email"])) {
    require "config.php";
    $name = $_POST["email"];
    $pss = "select * from login where fname = '$name'";
    $query = mysqli_query($conn, $pss) ;
                    ...
                    <div class="account-text-wrapper">
                        ...
                        <div class="col-md-3">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                ...
                                <a href="login.php?p1=out"><i class="fa fa-sign-out"></i> Logout</a>
                            </div>
                        </div>
                            ...
                            <div class="tab-content" id="myaccountContent">
                                ...
                                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <div class="welcome">
                                            <p>Hello, <strong><?php echo $_SESSION["fname"]." ".$_SESSION["lname"];?></strong> (If Not <strong><?php echo $_SESSION["fname"]?> !</strong><a
                                                    href="login.php?p1=out" class="logout"> Logout</a>)</p>
                                        </div>
