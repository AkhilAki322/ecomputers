                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <nav class="woocommerce-breadcrumb">
                                ...
                                <span class="separator">/</span> Used Laptops
                            </nav>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 col-md-9 shop-content">
                            ...
                            <div class="product-toolbar">
                                <div class="topbar-title">
                                    <h1 style="margin-bottom: 10px;">Used Laptops</h1>
                                </div>
                                                    ...
                                                    <div class="product-wrapper gridview">
                                                        ...
                                                        <div class="list-col8">
                                                            <div class="product-info">
                                                                <h2><a href="single-product.html" data-toggle="modal" data-target="#product_modal"  data-original-title="Quick View"><b>Hp BX180TX i5 8th gen</b></a></h2>
                                                                <span class="price">
                                                                     ₹ 75.00
                                                                </span>
