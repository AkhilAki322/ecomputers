                            ...
                            <form class="form-register" action="login.php" method="POST">
                                <fieldset>
                                    ...
                                    <div class="form-group d-md-flex align-items-md-center">
                                        ...
                                        <div class="col-md-10">
                                            <input type="email" class="form-control" id="email" placeholder="Enter you email address here..." name="email">
                                        </div>
                                    </div>
                                    <div class="form-group d-md-flex align-items-md-center">
                                        <label class="control-label col-md-2" for="number"><span class="require">*</span>Mobile No</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" id="number" placeholder="Mobile No" name="number">
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    ...
                                    <div class="form-group d-md-flex align-items-md-center">
                                        ...
                                        <div class="col-md-10">
                                            <input type="password" class="form-control" id="pwd-confirm" placeholder="Confirm password" name="password">
                                        </div>
                                    </div>
                                </fieldset>
